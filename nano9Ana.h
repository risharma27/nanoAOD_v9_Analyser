...
public :
  ...
  */
  ...
  //JetCalo
  /*
  TTreeReaderValue<UInt_t>  nJetCalo =          {fReader_Data, "nJetCalo"};
  ...
  //JetPuppi
  /*
  TTreeReaderValue<UInt_t>  nJetPuppi =                {fReader_Data, "nJetPuppi"};
  ...
  */
  ...
  /*
  //FatJetCHS
  TTreeReaderValue<UInt_t> nFatJetCHS =                  {fReader_Data, "nFatJetCHS"};
  ...
  TTreeReaderValue<UInt_t> nFatJetForJEC =               {fReader_Data, "nFatJetForJEC"};
  ...
  /*
  //PPSLocalTrack
  TTreeReaderValue<UInt_t> nPPSLocalTrack =                 {fReader_Data, "nPPSLocalTrack"};
  ...
  /*
  //Proton_singleRP
  TTreeReaderValue<UInt_t> nProton_singleRP =        {fReader_Data, "nProton_singleRP"};
  ...
  TTreeReaderValue<UInt_t>  nGenJetAK8 =     {fReader_MC, "nGenJetAK8"};
  ...
  TTreeReaderValue<UInt_t>  nSubGenJetAK8 =              {fReader_MC, "nSubGenJetAK8"};
  ...
  TTreeReaderValue<UInt_t>  nLHEPart =           {fReader_MC, "nLHEPart"};
  ...
  TTreeReaderValue<UInt_t>  nGenDressedLepton =          {fReader_MC, "nGenDressedLepton"};
  ...
  TTreeReaderValue<UInt_t>  nGenIsolatedPhoton =         {fReader_MC, "nGenIsolatedPhoton"};
  ...
  struct Hists {
    ...
    TH1F *bjets;
    TH1F *mu[3];
    TH1F *muprop[4]; //This is an array of 4 histograms.
    TH1F *submuprop[3];
    TH1F *dimuon[3];
    TH1F *eprop[3];
    TH1F *subeprop[3];
...
private:
  ...
  vector<Lepton> goodLepton;

  vector<Lepton> btagged_jet;
